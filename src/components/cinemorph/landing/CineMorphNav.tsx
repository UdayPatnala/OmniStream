 ...
 */
export const CineMorphNav: React.FC<CineMorphNavProps> = () => {
  return (
      ...
      <div className="w-full max-w-7xl flex items-center justify-between">
        ...
        >
          <img
            src="/omn_logo.jpg"
            alt="OMS"
            className="w-8 h-8 sm:w-9 sm:h-9 rounded-full object-cover filter drop-shadow-[0_2px_8px_rgba(0,0,0,0.5)]"
          />
        </Link>
      </div>
    </header>
