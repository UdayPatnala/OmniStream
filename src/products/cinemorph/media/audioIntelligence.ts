...
import { IAudioPerceptionProvider, IAudioPerceptionEvidence } from '@omnistream/core/oms/interfaces';
import { PerceptionNormalizer, NullAudioPerceptionProvider } from '@omnistream/core/oms/perceptionNormalizer';
