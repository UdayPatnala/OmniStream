/**
 * posterService.ts â€” OmniStream Dynamic Video Poster & Preview Extraction Engine
...
class PosterService {
  ...
  public async resolvePoster(req: MediaPosterRequest): Promise<ResolvedPoster> {
    ...
    // â”€â”€ PRIORITY 1: Explicit high-quality poster / thumbnail passed in â”€â”€
    if (req.posterUrl) {
    ...
    // â”€â”€ PRIORITY 2: Remote YouTube Video ID â”€â”€
    ...
    // â”€â”€ PRIORITY 3: Client-Side Local Video Intelligent Frame Capture â”€â”€
    ...
    // â”€â”€ PRIORITY 4: Graceful CineMorph Official Fallback Artwork â”€â”€
